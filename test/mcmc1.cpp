...
int main( int argc, char *argv[] )
{
  ...
  hmlp::Data<T> beta_m( n_mixtures, q );
  hmlp::Data<T> alpha_a( n_mixtures, q ); 
  ...
  beta_m.readmatrix( n_mixtures, q, beta_m_filename );
  alpha_a.readmatrix( n_mixtures, q, alpha_a_filename );
  ...
  mcmc::mcmc<T>( Y, A, M, C1, C2, beta_m, alpha_a, pi_mixtures, Psi, n, w1, w2, q, q1, q2, burnIn, niter, permute );
